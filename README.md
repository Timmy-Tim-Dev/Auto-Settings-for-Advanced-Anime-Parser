...
<p>Для DLE 19.1 и выше необходимо 3 файла <b style="color:red">'mysqlinject.php, rules.json, xfields.json'<b> закинуть в папку <b style="color:red">сайт/engine/data/<b></p><br/>
